...
```bash
docker run --name sandbox-kind --shm-size=4096m -v /var/run/docker.sock:/var/run/docker.sock -v "c:/users/Muhammad Asim/Desktop/sandbox:/mnt" -w /mnt -p 6901:6901 -e VNC_PW=password -id docker pull kasmweb/ubuntu-jammy-desktop:latest
```
